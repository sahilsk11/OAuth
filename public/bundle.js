...
For more info, visit https://fb.me/react-mock-scheduler`);
  ...
  var require_google_login = __commonJS((exports, module) => {
    !function(e, t) {
      ...
      return o = {}, t.m = n = [function(t2) {
          ...
          return function(e4) {
            ...
            if (e4) {
              if ("string" == typeof e4)
                return l(e4, t4);
              var n3 = Object.prototype.toString.call(e4).slice(8, -1);
              return "Object" === n3 && e4.constructor && (n3 = e4.constructor.name), "Map" === n3 || "Set" === n3 ? Array.from(n3) : "Arguments" === n3 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n3) ? l(e4, t4) : void 0;
            }
          }(e3, t3) || function() {
            throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
          }();
        ...
        function f(e3, t3, n3, o3, r2) {
          var i2 = e3.getElementsByTagName(t3)[0], a2 = i2, c2 = i2;
          (c2 = e3.createElement(t3)).id = n3, c2.src = o3, a2 && a2.parentNode ? a2.parentNode.insertBefore(c2, a2) : e3.head.appendChild(c2), c2.onload = r2;
        }
        function d(e3, t3) {
        ...
        function y(e3) {
          var t3 = i(Object(m.useState)(false), 2), n3 = t3[0], o3 = t3[1], r2 = i(Object(m.useState)(false), 2), a2 = r2[0], c2 = r2[1], u2 = e3.tag, s2 = e3.type, l2 = e3.className, f2 = e3.disabledStyle, d2 = e3.buttonText, y2 = e3.children, v2 = e3.render, S2 = e3.theme, j2 = e3.icon, O2 = e3.disabled, x = h({onSuccess: e3.onSuccess, onAutoLoadFinished: e3.onAutoLoadFinished, onRequest: e3.onRequest, onFailure: e3.onFailure, clientId: e3.clientId, cookiePolicy: e3.cookiePolicy, loginHint: e3.loginHint, hostedDomain: e3.hostedDomain, autoLoad: e3.autoLoad, isSignedIn: e3.isSignedIn, fetchBasicProfile: e3.fetchBasicProfile, redirectUri: e3.redirectUri, discoveryDocs: e3.discoveryDocs, uxMode: e3.uxMode, scope: e3.scope, accessType: e3.accessType, responseType: e3.responseType, jsSrc: e3.jsSrc, prompt: e3.prompt}), I = x.signIn, w = O2 || !x.loaded;
          if (v2)
          ...
          return b.a.createElement(u2, {onMouseEnter: function() {
            ...
            return c2(false);
          }, onClick: I, style: _, type: s2, disabled: w, className: l2}, [j2 && b.a.createElement(g, {key: 1, active: a2}), b.a.createElement(p, {icon: j2, key: 2}, y2 || d2)]);
        }
        ...
        var m = n2(0), b = n2.n(m), h = (n2(1), function(e3) {
          function t3(e4) {
            var t4 = e4.getBasicProfile(), n4 = e4.getAuthResponse();
          ...
          function n3(e4) {
            if (e4 && e4.preventDefault(), P) {
              var n4 = window.gapi.auth2.getAuthInstance(), o3 = {prompt: T};
              p2(), "code" === A ? n4.grantOfflineAccess(o3).then(function(e5) {
                return i2(e5);
              }, function(e5) {
                return s2(e5);
          ...
          } : a2, u2 = e3.onFailure, s2 = void 0 === u2 ? function() {
          } : u2, l2 = e3.onRequest, p2 = void 0 === l2 ? function() {
          } : l2, g2 = e3.clientId, y2 = e3.cookiePolicy, b2 = e3.loginHint, h2 = e3.hostedDomain, v2 = e3.autoLoad, S2 = e3.isSignedIn, j2 = e3.fetchBasicProfile, O2 = e3.redirectUri, x = e3.discoveryDocs, I = e3.uxMode, w = e3.scope, k = e3.accessType, A = e3.responseType, _ = e3.jsSrc, E = void 0 === _ ? "https://apis.google.com/js/api.js" : _, T = e3.prompt, M = o2(Object(m.useState)(false), 2), P = M[0], L = M[1];
          return Object(m.useEffect)(function() {
            var e4 = false;
            return f(document, "script", "google-login", E, function() {
              var n4 = {client_id: g2, cookie_policy: y2, login_hint: b2, hosted_domain: h2, fetch_basic_profile: j2, discoveryDocs: x, ux_mode: I, redirect_uri: O2, scope: w, access_type: k};
              "code" === A && (n4.access_type = "offline"), window.gapi.load("auth2", function() {
                var o3 = window.gapi.auth2.getAuthInstance();
                o3 ? S2 && o3.isSignedIn.get() ? (L(true), c2(true), t3(o3.currentUser.get())) : e4 || (L(true), c2(false)) : window.gapi.auth2.init(n4).then(function(n5) {
                  if (!e4) {
                    L(true);
                    var o4 = S2 && n5.isSignedIn.get();
                    c2(o4), o4 && t3(n5.currentUser.get());
                  }
                }, function(e5) {
                  L(true), c2(false), s2(e5);
                });
              });
            }), function() {
        ...
        function v(e3) {
          var t3 = s(Object(m.useState)(false), 2), n3 = t3[0], o3 = t3[1], r2 = s(Object(m.useState)(false), 2), i2 = r2[0], a2 = r2[1], c2 = e3.tag, u2 = e3.type, l2 = e3.className, f2 = e3.disabledStyle, d2 = e3.buttonText, y2 = e3.children, h2 = e3.render, v2 = e3.theme, S2 = e3.icon, O2 = e3.disabled, x = j({jsSrc: e3.jsSrc, onFailure: e3.onFailure, clientId: e3.clientId, cookiePolicy: e3.cookiePolicy, loginHint: e3.loginHint, hostedDomain: e3.hostedDomain, fetchBasicProfile: e3.fetchBasicProfile, discoveryDocs: e3.discoveryDocs, uxMode: e3.uxMode, redirectUri: e3.redirectUri, scope: e3.scope, accessType: e3.accessType, onLogoutSuccess: e3.onLogoutSuccess}), I = x.signOut, w = O2 || !x.loaded;
          if (h2)
          ...
          return b.a.createElement(c2, {onMouseEnter: function() {
            ...
            return a2(false);
          }, onClick: I, style: _, type: u2, disabled: w, className: l2}, [S2 && b.a.createElement(g, {key: 1, active: i2}), b.a.createElement(p, {icon: S2, key: 2}, y2 || d2)]);
        }
        ...
        var S = y, j = function(e3) {
          var t3 = e3.jsSrc, n3 = void 0 === t3 ? "https://apis.google.com/js/api.js" : t3, o3 = e3.onFailure, r2 = e3.clientId, i2 = e3.cookiePolicy, a2 = e3.loginHint, u2 = e3.hostedDomain, s2 = e3.fetchBasicProfile, l2 = e3.discoveryDocs, p2 = e3.uxMode, g2 = e3.redirectUri, y2 = e3.scope, b2 = e3.accessType, h2 = e3.onLogoutSuccess, v2 = c(Object(m.useState)(false), 2), S2 = v2[0], j2 = v2[1];
          return Object(m.useEffect)(function() {
            return f(document, "script", "google-login", n3, function() {
              var e4 = {client_id: r2, cookie_policy: i2, login_hint: a2, hosted_domain: u2, fetch_basic_profile: s2, discoveryDocs: l2, ux_mode: p2, redirect_uri: g2, scope: y2, access_type: b2};
              window.gapi.load("auth2", function() {
                window.gapi.auth2.getAuthInstance() ? j2(true) : window.gapi.auth2.init(e4).then(function() {
                  return j2(true);
                }, function(e5) {
                  return o3(e5);
                });
            ...
            if (window.gapi) {
              ...
              null != e4 && e4.signOut().then(e4.disconnect().then(h2));
            }
          }, loaded: S2};
        };
  ...
  const react_google_login = __toModule(require_google_login());
  function App() {
    const clientId = "test";
    const gBtn = React.createElement(react_google_login.default, {
      clientId,
    ...
    return React.createElement("div", null, gBtn);
  }
  const handleLogin = () => {
  };
